...
public class Constantes {
	...
	// Color pallete
		...
		static final Color c = new Color (41,32,38);
		static final Color c1 = new Color (101, 92, 98);
		static final Color b = new Color (0, 180, 250);
		static final Color red = new Color (250, 0, 0);
		// Size defaults
